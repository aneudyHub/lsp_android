...
import com.herprogramacion.peopleapp.provider.DatabaseHandler;
import com.herprogramacion.peopleapp.provider.ProcesadorLocal;
import com.herprogramacion.peopleapp.provider.ProcesadorRemoto;
import com.herprogramacion.peopleapp.utilidades.Resolve;
import com.herprogramacion.peopleapp.utilidades.UPreferencias;
import com.herprogramacion.peopleapp.utilidades.URL;
...
public class HistorialPagos {
    ...
    public void synCuotaPagaLocal(String fecha) {
        ...
        //if(t){
        new RESTService(context).get(URL.SERVER+URL.HISTORIAL+"?fecha="+fecha,
